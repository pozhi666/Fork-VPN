...
impl IClashTemp {
    ...
    pub async fn save_config(&self) -> Result<()> {
        help::save_yaml(&dirs::clash_path()?, &self.0, Some("# Generated by Fork")).await
    }
...
fn test_clash_info() {
    ...
    assert_eq!(
        ...
        get_result(network::ports::DEFAULT_MIXED, network::DEFAULT_EXTERNAL_CONTROLLER)
    );
    ...
    assert_eq!(
        get_case(65537, ""),
        get_result(1, network::DEFAULT_EXTERNAL_CONTROLLER)
    );
    ...
    assert_eq!(
        get_case(8888, "   :98888 "),
        get_result(8888, network::DEFAULT_EXTERNAL_CONTROLLER)
    );
