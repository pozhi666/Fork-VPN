...
pub async fn import_profile(url: std::string::String, option: Option<PrfOption>) -> CmdResult {
    crate::commercial::ensure_import_allowed().stringify_err()?;
...
pub async fn update_profile(index: String, option: Option<PrfOption>) -> CmdResult {
    // Official profile has no remote URL — must use commercial sync.
    crate::commercial::guard::ensure_not_official_profile(&index, "刷新")
        .await
        .stringify_err()?;
...
pub async fn delete_profile(index: String) -> CmdResult {
    crate::commercial::guard::ensure_not_official_profile(&index, "删除")
        .await
        .stringify_err()?;
...
pub async fn patch_profile(index: String, profile: PrfItem) -> CmdResult {
    crate::commercial::guard::ensure_not_official_profile(&index, "修改")
        .await
        .stringify_err()?;
