...
import { ISOLATED_DEFAULT_MIXED_PORT } from '@/config/commercial'
...
export const AppDataProvider = ({
  ...
  const systemValue = useMemo(() => {
    const calculateSystemProxyAddress = () => {
      ...
      // Always show *this app's* listen address (Fork uses 17897).
      // Do NOT display Windows system proxy as-is — stock Clash may own 7897
      // and would make the detail line look like a port conflict.
