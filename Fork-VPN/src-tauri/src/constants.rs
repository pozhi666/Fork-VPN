...
pub mod network {
    /// Commercial isolation: shifted away from stock Fork ports.
    pub const DEFAULT_EXTERNAL_CONTROLLER: &str = crate::commercial::ports::DEFAULT_EXTERNAL_CONTROLLER;

    pub mod ports {
        #[cfg(not(target_os = "windows"))]
        pub const DEFAULT_REDIR: u16 = crate::commercial::ports::DEFAULT_REDIR;
        #[cfg(target_os = "linux")]
        pub const DEFAULT_TPROXY: u16 = crate::commercial::ports::DEFAULT_TPROXY;
        pub const DEFAULT_MIXED: u16 = crate::commercial::ports::DEFAULT_MIXED;
        pub const DEFAULT_SOCKS: u16 = crate::commercial::ports::DEFAULT_SOCKS;
        pub const DEFAULT_HTTP: u16 = crate::commercial::ports::DEFAULT_HTTP;

        pub const SINGLETON_SERVER: u16 = crate::commercial::ports::SINGLETON_SERVER;
    }
}
