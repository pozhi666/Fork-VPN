...
mod app_init {
    ...
    pub fn generate_handlers() -> impl Fn(tauri::ipc::Invoke<tauri::Wry>) -> bool + Send + Sync + 'static {
        tauri::generate_handler![
            ...
            // commercial mode
            cmd::get_commercial_status,
            cmd::commercial_register,
            cmd::commercial_send_email_code,
            cmd::commercial_email_status,
            cmd::commercial_password_reset_request,
            cmd::commercial_password_reset_complete,
            cmd::commercial_delete_account_send_code,
            cmd::commercial_delete_account,
            cmd::commercial_login,
            cmd::commercial_logout,
            cmd::commercial_get_session,
            cmd::commercial_sync_subscription,
            cmd::commercial_get_catalog,
            cmd::commercial_purchase,
            cmd::commercial_get_order,
            cmd::commercial_list_orders,
            cmd::commercial_get_profile,
            cmd::commercial_change_password,
            cmd::commercial_redeem_coupon,
            cmd::commercial_change_email,
            cmd::commercial_report_traffic,
            cmd::commercial_remove_device,
            cmd::commercial_get_catalog_item,
            cmd::commercial_preview_checkout,
            cmd::commercial_balance_packs,
            cmd::commercial_balance_topup,
            cmd::commercial_list_tickets,
            cmd::commercial_create_ticket,
            cmd::commercial_get_ticket,
            cmd::commercial_reply_ticket,
            cmd::commercial_close_ticket,
            cmd::commercial_checkin_status,
            cmd::commercial_do_checkin,
            cmd::commercial_invite_info,
            cmd::commercial_get_announcements,
            cmd::commercial_check_app_update,
        ]
    }
}
    ...
    mod event_handlers {
        ...
        pub fn handle_ready_resumed(_app_handle: &AppHandle) {
            ...
            if let Some(window) = _app_handle.get_webview_window("main") {
                let _ = window.set_title(crate::commercial::PRODUCT_NAME);
            }
        }
